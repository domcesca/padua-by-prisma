// The product's name in one place. Padua is owned by Prisma Executive, a consulting firm; it is not an HCAI, CMS,
// CDPH, DHCS, or university product, and copy shouldn't suggest otherwise. The public data it's built on is credited
// where it's used.
...
export const APP_ATTRIBUTION =
  "An independent tool from Prisma Executive, built on public data from HCAI, CMS, CDPH, and DHCS. Not affiliated with those agencies."
